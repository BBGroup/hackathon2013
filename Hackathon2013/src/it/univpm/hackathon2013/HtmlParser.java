...
public class HtmlParser {
	...
	public HtmlParser(Activity activity, int bacino) {
		...
		riga = new ArrayList();
		riga.add("006");
		riga.add("Gola della Rossa");
		riga.add(0);
		bacino3.add(riga);
		riga = new ArrayList();
		riga.add("005");
		riga.add("Camponocecchio");
		riga.add(0);
		bacino3.add(riga);
		riga = new ArrayList();
		riga.add("004");
		riga.add("San Vittore");
		riga.add(0);
		riga = new ArrayList();
		bacino3.add(riga);
		riga.add("505");
		riga.add("Sassoferrato");
		riga.add(0);
		bacino3.add(riga);
		...
		riga = new ArrayList();
		riga.add("118");
		riga.add("Cupramontana");
		riga.add(1);
		bacino3.add(riga);
		riga = new ArrayList();
		riga.add("504");
		riga.add("San Giovanni");
		riga.add(1);
		bacino3.add(riga);
		riga = new ArrayList();
		riga.add("502");
		riga.add("Campodiegogli");
		riga.add(1);
		bacino3.add(riga);
		riga = new ArrayList();
		riga.add("503");
		riga.add("Esanafoglia");
		riga.add(1);
		bacino3.add(riga);
